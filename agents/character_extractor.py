...
- In static features, you need to describe the character's general appearance (hair color, hair style, age range) and other relatively unchanging features. AVOID describing body shape, physique, or physical attributes. In dynamic features, you need to describe the character's attire (loose-fitting, casual clothing), accessories, key items they carry, and other easily changeable features.
...
- The description of characters should be detailed but conservative, avoiding the use of abstract terms or physical attribute descriptions. Instead, employ safe descriptions that can be visualized—such as specific clothing colors (e.g., blue shirt, green dress) and basic facial features (e.g., short hair, long hair, glasses).
"""
